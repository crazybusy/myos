...
$COMPILER $COMPILER_PARAMS -I $ARCH_FOLDER/include -I $LIBRARY_FOLDER/include -I $KERNEL_FOLDER/include -I $DEVICES_FOLDER/include $ARCH_FOLDER/descriptor_tables.c -o $BUILD_FOLDER/descriptor_tables.o 
...
$COMPILER $COMPILER_PARAMS $LIBRARY_FOLDER/stdio.c -o $BUILD_FOLDER/stdio.o 
$COMPILER $COMPILER_PARAMS $LIBRARY_FOLDER/stdlib.c -o $BUILD_FOLDER/stdlib.o 
